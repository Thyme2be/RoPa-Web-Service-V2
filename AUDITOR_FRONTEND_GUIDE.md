...
| `stats.pending_since_yesterday` | ตัวเลขสีแดงใต้ card "รายการที่รอการตอบกลับ" | นับ form rows ที่ยัง `pending_review` **และ** `sent_to_auditor_at >= วันนี้ 00:00** (เพิ่มขึ้นจากเมื่อวาน) |
