        ...
        <label className={cn(
            ...
            <div className="relative flex items-center justify-center w-5 h-5">
                <input
                    ...
                    {...props}
                    onClick={handleClick}
                    className="peer appearance-none h-5 w-5 border border-gray-300 rounded-full checked:border-primary checked:border-[6px] transition-all cursor-pointer bg-white"
                />
            </div>
        </label>
    );
