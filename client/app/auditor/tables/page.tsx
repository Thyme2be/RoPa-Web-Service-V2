  ...
  const fetchDocuments = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/dashboard/documents-from-dpo?${queryParams.toString()}`,
        {
          headers: {
      ...
      <div className="flex-1 p-8 space-y-6">
        ...
        <div>
          <h2 className="text-[28px] font-headline font-black text-[#1B1C1C] tracking-tight mb-1">
            ตารางแสดงเอกสารที่ได้รับจากเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล
          </h2>
        </div>
        ...
        <div className="relative z-10">
          <ListCard
            title="เอกสารที่ได้รับจากเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล"
                ...
                <tbody className="divide-y divide-[#E5E2E1]/10">
                  {loading ? (
                    ...
                    <tr>
                      <td
                        colSpan={6}
                        className="py-12 text-center text-[#ED393C] font-black tracking-tight"
                      >
                        {error}
                      </td>
                    </tr>
                      ...
                      >
                        <td className="py-4 text-[13.5px] font-medium text-left pl-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[#1B1C1C] font-medium tracking-tight">
                              {doc.document_name}
                            </span>
                          </div>
                        </td>
                        <td className="py-4 text-[13.5px] font-medium text-[#5F5E5E] text-center">
                          {doc.reviewer_name}
                        </td>
                        <td className="py-4 text-[13.5px] font-medium text-[#5F5E5E] text-center">
