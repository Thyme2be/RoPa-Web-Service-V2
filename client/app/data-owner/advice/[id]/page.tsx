...
export default function SuggestionDetailPage() {
    ...
    const record = mockOwnerRecords.find((r) => r.id === id);
    ...
    // Determine page role from the first suggestion's role
        ...
        <div className="flex min-h-screen bg-[#FCF9F8]">
            ...
            <main className="flex-1 ml-[var(--sidebar-width)] flex flex-col bg-surface-container-low min-w-0">
                ...
                <div className="p-8 space-y-6 max-w-[1400px] mx-auto w-full">
                    ...
                    {/* Header Info Grid - Matches screenshot layout */}
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-x-24 gap-y-1">
                                <div className="text-[17px] font-bold text-[#1B1C1C] flex items-center gap-2">
                                    <span className="text-[#5C403D] font-medium">รหัสเอกสาร :</span> <span>{record.id}</span>
                                </div>
                                <div className="text-[17px] font-bold text-[#1B1C1C] flex items-center gap-2">
                                    <span className="text-[#5C403D] font-medium">วันที่แก้ไขล่าสุด :</span> <span>26/03/2026, 14:30</span>
                                </div>
                            </div>
                            <div className="text-[17px] font-bold text-[#1B1C1C] flex items-center gap-2 pt-1">
                                <span className="text-[#5C403D] font-medium">ผู้ตรวจสอบ :</span> <span>วิริยา พรหมรักษ์</span>
                            </div>
                        </div>

                        <button className="flex items-center gap-2 bg-[#E5E7EB] px-6 py-2.5 rounded-lg text-[15px] font-black text-[#1B1C1C] hover:bg-[#D1D5DB] transition-all cursor-pointer shadow-sm">
