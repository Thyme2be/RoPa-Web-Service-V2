...
const tableMenus = [
    {
        ...
        path: "/dpo/tables/in-progress"
    },
    {
        title: "ตารางแสดงเอกสารที่ขอทำลาย",
        path: "/dpo/tables/destruction"
    },
    {
        title: "ตารางแสดงเอกสารที่ส่งให้ผู้ตรวจสอบ",
        path: "/dpo/tables/auditor-submission"
    }
];

export default function DPOTablesMenuPage() {
    return (
        <div className="max-w-[1440px] mx-auto pb-12 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="mb-8">
                ...
                <p className="text-[#5C403D] text-[18px] font-medium font-headline">ตารางแสดงรายละเอียดเอกสารและสถานะการดำเนินการปัจจุบัน</p>
            </div>
            ...
            <div className="flex flex-col gap-4 w-full">
                {tableMenus.map((menu, index) => (
                    ...
                    >
                        ...
                        {/* Right Arrow Icon */}
                        <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-[#E54545] mr-2 transition-transform group-hover:translate-x-1">
                            <span className="material-symbols-outlined text-[#E54545] text-lg font-black">
                                arrow_forward
                            </span>
                        </div>
                    </Link>
