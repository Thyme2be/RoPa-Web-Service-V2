...
/**
 * Ropa Specific Mock Records
 * These records are enhanced with full DPO Audit fields and logic.
 */
...
export const mockProcessorRecords: RopaProcessorRecord[] = [
    {
        ...
        personalData: "ชื่อ-นามสกุล, เลขประจำตัวประชาชน, เงินเดือน, เลขประจำตัวผู้เสียภาษี",
        dataCategories: ["employee"],
        dataType: [DataType.General, DataType.Sensitive],
        ...
        retention: {
            ...
            accessCondition: "เพื่อการคำนวณและจ่ายเงินเดือนตามรอบบัญชีเท่านั้น",
        ...
        securityMeasures: {
            ...
            responsibility: "เจ้าหน้าที่ IT และ HR"
        }
    },
    {
        id: "RP-2026-03",
