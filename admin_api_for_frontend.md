...
```json
{
  ...
  "total_users_trend": {            // 🔴 ใช้หลักการคำนวณแบบ Cumulative Base Growth (ยอดพนักงานใหม่เดือนนี้ / ฐานพนักงานก่อนเดือนนี้ทั้งหมด) เพื่อหาอัตราขยายตัวขององค์กร
    "direction": "up",              // (str) ชนิดแนวโน้ม ("up", "down", "neutral")
    "value": "+12%",                // (str) สตริงตัวเลขความเปลี่ยนเเปลง
    "text_label": "จากเดือนที่แล้ว"       // (str) ป้ายกำกับ
  },
